  ...
  <div class="space-y-3">
   ...
   <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
    ...
    <div class="grid grid-cols-1 gap-1">
     <label
      v-if="counter.countMode === 'comment' || counter.countMode === 'user'"
   ...
   <div
    v-if="counter.countMode === 'comment' || counter.countMode === 'user'"
    class="form-control bg-base-200 p-3 rounded-lg"
   >
...
import { ConfigUserType, CounterConfig, serviceTypeValues } from '@/scripts/schema';
