// common/subscribe/GetUserBingo.ts
import { ref } from 'vue';
...
/**
 * データはすべて差分モード(過去のデータを引っ張る機能は今回搭載しない)
 *
 * Q.どんなデータが必要？
 * 1-25という名前のキーがあり
 * 数値が返ってくる。
 * そのまま数値を適用すればいいので、refは必要
 *
 * Q. 追加の型定義は
 *
 *
...
export function GetUserBingo(config: ConfigUserType, isFirstComment: boolean = false) {
