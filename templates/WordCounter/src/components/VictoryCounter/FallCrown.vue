...
// Track count changes to trigger animations
...
// Function to trigger and reset animations
...
// Progress styles with more playful gradients
...
// Get text and style based on progress
